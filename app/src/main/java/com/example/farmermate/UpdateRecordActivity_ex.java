...
public  class UpdateRecordActivity_ex extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    private void goBackHome(){
        startActivity(new Intent(this, ExpenseMoney.class));
    }
