...
import com.example.certificate.certificate.CertificateUtils;
...
public abstract class GenericRequestTask extends AsyncTask<String, String, TaskOutput> {
    ...
    protected WeatherPage activity;
    ...
    public GenericRequestTask(Context context, WeatherPage activity, ProgressDialog progressDialog) {
    ...
    private String makeRequest(TaskOutput output, String response, String[] reqParams) {
        try {
            ...
            if (urlConnection.getResponseCode() == 200) {
                ...
                WeatherPage.saveLastUpdateTime( PreferenceManager.getDefaultSharedPreferences(context));
