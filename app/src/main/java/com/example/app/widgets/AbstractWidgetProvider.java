...
import com.example.farmermate.BuildConfig;
import com.example.farmermate.Formatting;
import com.example.farmermate.R;
import com.example.farmermate.UnitConvertor;
import com.example.farmermate.Weather;
...
public abstract class AbstractWidgetProvider extends AppWidgetProvider {
    ...
    protected Weather parseWidgetJson(String result, Context context) {
        try {
            ...
            if (lastUpdateTimeInMillis < 0) {
                ...
                lastUpdate = context.getString(R.string.last_update_widget, WeatherPage.formatTimeWithDayIfNotToday(context, lastUpdateTimeInMillis));
            }
            ...
            widgetWeather.setWind(context.getString(R.string.wind) + ": " + new DecimalFormat("0.0").format(wind) + " " + localize(sp, context, "speedUnit", "m/s")
                    + (widgetWeather.isWindDirectionAvailable() ? " " + WeatherPage.getWindDirectionString(sp, context, widgetWeather) : ""));
    ...
    protected String localize(SharedPreferences sp, Context context, String preferenceKey,
        ...
        return WeatherPage.localize(sp, context, preferenceKey, defaultValueKey);
    }
